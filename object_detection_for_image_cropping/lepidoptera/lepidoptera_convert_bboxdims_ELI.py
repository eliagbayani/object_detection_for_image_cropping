...
import sys
# run command-line:
# python3 lepidoptera_convert_bboxdims_ELI.py 1
# python3 lepidoptera_convert_bboxdims_ELI.py 2
# python3 lepidoptera_convert_bboxdims_ELI.py 31
...
for i, row in df.iterrows():
    # Optional: Pad by XX% larger crop dimension
