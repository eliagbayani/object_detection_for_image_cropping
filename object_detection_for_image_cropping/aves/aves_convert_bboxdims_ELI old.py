...
crops.to_csv('../data_files/output/Aves/bird_crops_rcnn_1000img_display_test_bef_pad.tsv', sep='\t', index=True)
...
crops.to_csv('../data_files/output/Aves/bird_crops_rcnn_1000img_display_test.tsv', sep='\t', index=True)
...
eol_crops.to_csv('../data_files/output/Aves/bird_crops_rcnn_1000img.tsv', sep='\t', index=False)
